  ...
  return (
    <div>
      ...
      >
        ...
        {dictionary.quiz.results.profilesVideoTitle}
      </Button>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="container transform overflow-hidden rounded-2xl bg-[#1B2B42] pt-16 pb-4 md:pb-6 px-4 md:px-24 text-center shadow-xl transition-all">
                  ...
                  <iframe
                    src="https://www.youtube-nocookie.com/embed/aoT9A3YAnm4?si=0aF-O3654qyhyUf5"
                    className="w-full aspect-video rounded-2xl"
                    title={dictionary.quiz.results.profilesVideoTitle}
                    frameBorder="0"
